...
ctx.lists["user.py_imports"] = {
    ...
    "base model": "from pydantic import BaseModel",
    ...
    "date time": "from datetime import datetime, timezone",
    "time delta": "from datetime import timedelta",
    "data class": "from dataclasses import dataclass, field",
    "pie plot": "import matplotlib.pyplot as plt",
    "num pie": "import numpy as np",
...
ctx.lists["user.functions"] = {
    ...
    "count": "count",
    "ends with": "endswith",
    "date time now": "datetime.now(timezone.utc)[|]",
    "enumerate": "enumerate",
    "exists": "exists",
    "extend": "extend",
    "find all": "find_all",
