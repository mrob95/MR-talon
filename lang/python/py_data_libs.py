...
ctx.lists["py_lib_numpy"] = {
    ...
    "busday count": "np.busday_count",
    "busday offset": "np.busday_offset",
    ...
    "compare chararrays": "np.compare_chararrays",
    "compat": "np.compat!",
    "complex": "np.complex",
    ...
    "get printoptions": "np.get_printoptions",
    "getbufsize": "np.getbufsize",
    "geterr": "np.geterr",
    "geterrcall": "np.geterrcall",
    "geterrobj": "np.geterrobj",
