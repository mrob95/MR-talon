title: /JupyterLab/
-
next pane <user.n20>: key("ctrl-shift-]:{n20}")
previous pane <user.n20>: key("ctrl-shift-[:{n20}")
replace: key("ctrl-shift-r")
toggle cyber: key("ctrl-b")
(insert | new) cell: key("alt-enter")
run cell: key("ctrl-enter")
(next cell | necker) <user.n20>: key("shift-enter:{n20}")
